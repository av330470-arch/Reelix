                ...
                IconButton(
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Virtual Gift Sent! +$0.50 credited to creator.')),
                    );
                  },
                ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text('$1,240.50', style: TextStyle(color: Colors.amberAccent, fontSize: 28, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
